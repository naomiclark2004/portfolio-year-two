    ...
    return (
      <>
        <div className="navbar">
          ...
          <Link href="https://github.com/naomiclark2004" target="_blank">
            Github
          </Link>
          <Link href="https://west-mec.edu/coding/" target="_blank">
            Program
          </Link>
        </div>
        ...
        <div className="header">
          ...
          <div className="content">
            ...
            <p>
              Skills: HTML5, CSS, SASS, JS, Bootstrap, JQuery, Node.js,
              Express.js, React.js, React Native, Next.js, MongoDB, PHP, and
              MySQL.
            </p>
          </div>
        </div>
        ...
        <div className="button">
          <button
            onClick={() => setSort(-1)}
            className={sort === -1 ? "button active" : "button"}
            id="new"
          >
            Newest
          </button>
          <button
            onClick={() => setSort(1)}
            className={sort === 1 ? "button button2 active" : "button button2"}
            id="old"
          >
            Oldest
          </button>
                        ...
                        if (project.collaborator !== undefined) {
                          return (
                            <>
                              Collaborator:{" "}
                              <Link
                                href={{ pathname: `${project.collablink}` }}
                                target="_blank"
